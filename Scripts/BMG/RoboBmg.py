...
def start():
    ...
    driver.find_element(By.XPATH,"xpath=//span[contains(.,'Mostrar todos os CDB BMG DI')]").click()
    driver.find_element(By.XPATH,"xpath=//span[contains(.,'Mostrar todos os CDB BMG IPCA +')]").click()
    driver.find_element(By.XPATH,"xpath=//span[contains(.,'Mostrar todos os CDB BMG PRÉ')]").click()
    driver.get(dominio)
