...
def start():
    ...
    driver.find_element(By.XPATH,"//span[contains(text(),'Mostrar todos os CDB BMG DI')]").click()
    driver.find_element(By.XPATH,"//span[contains(text(),'Mostrar todos os CDB BMG IPCA +')]").click()
    driver.find_element(By.XPATH,"//span[contains(text(),'Mostrar todos os CDB BMG PRÉ')]").click()
    driver.get(dominio)
